# Contributing to Internet Information Services (IIS) Server Configs
...
The [issue tracker](https://github.com/h5bp/server-configs-iis/issues) is
...
your environment? What steps will reproduce the issue? What version of IIS
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/server-configs-iis.git
   # Navigate to the newly cloned directory
   cd server-configs-iis
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/h5bp/server-configs-iis
   ```
